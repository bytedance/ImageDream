...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        gr.Markdown(
            "imagedream demo for multi-view images generation from text and camera inputs."
        )
        with gr.Row():
            with gr.Column():
                ...
                elevation = gr.Slider(
                    0, 30, value=15, label="Elevation", info="Choose between 0 and 30"
                )
                azimuth = gr.Slider(
                    0, 360, value=0, label="Azimuth", info="Choose between 0 and 360"
                )
        ...
        gr.Examples(
            [
                ...
                ["Luffy from one piece, head, super detailed, best quality, 4K, HD"]
                + default_params,
                [
